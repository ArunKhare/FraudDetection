...
class DataIngestion:
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            save_file(strat_test_set, test_file_path, chunk_size)
            save_file(strat_train_set, train_file_path, chunk_size)
            is_ingested=True

            message = self.check_class_balance(strat_train_set,strat_test_set)
    ...
    @ staticmethod
    def check_class_balance(strat_train_set,strat_test_set) -> None:
        target_col = 'isFraud'
